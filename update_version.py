...
def main():
  ...
  plistpath = scriptpath + "/resources/DelayPlugin-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DelayPlugin-RTAS-Info.plist"
...
#   plistpath = scriptpath + "/resources/DelayPlugin-IOSAPP-Info.plist"
